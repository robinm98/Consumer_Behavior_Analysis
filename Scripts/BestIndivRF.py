...
# Function to train and evaluate a Random Forest model for a specific target variable
def train_and_evaluate_rf(target_var, other_vars):
    ...
    model = RandomForestClassifier(random_state=123, n_estimators=50, max_features=None, min_samples_split=10, min_samples_leaf=5, max_depth = 2)
