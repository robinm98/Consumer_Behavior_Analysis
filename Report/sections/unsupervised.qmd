...
For `wants_extra_baggage`, the proportion of bookings with extra baggage is rather similar across all clusters except for a slightly smaller proportion of bookings with extra baggage for cluster 2.
...
The distribution across the three clusters for `wants_in_flight_meals` is mixed. We can observe that Cluster 3 exhibits almost a 50/50 proportion of bookings with and without in-flight meals. Cluster 2 shows a strong proportion of bookings without in-flight meals, indicating a preference against this service. In contrast, Cluster 1 has a slight increase in bookings with in-flight meals compared to Cluster 2.
...
The distribution of bookings with preferred seats is similar across the three clusters, much like the proportion of bookings with extra baggage. Each cluster maintains a consistent proportion of bookings with and without preferred seats, indicating that the preference for this service is relatively uniform across all customer segments.
